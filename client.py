...
def main():
    try:
        """
        The socket definition and the first steps of the connection are in the
        log_in and sign_up functions.
        """
        ...
        # Creat thread for each operation to handle both at same time:
